...
<div 
 ...
 <a class="w-[100%] " href="#" >
     <img class="h-[38vh] w-[100%]  rounded-t-lg" src="../assets/images/<?=$filter["article_image"]?>" alt="product image" />
 </a>
 <div class="px-5 pb-5">
     <div class="h-[10vh]" >
     ...
     <div class="flex items-center justify-between  h-[20%]">
         ...
         <p class=" text-gray-600 text-[14px] 	"><?php  echo $filter["created_at"]; ?></p>
     </div>
     </div>
 </div>
 </div>
