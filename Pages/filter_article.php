...
<div
                    ...
                    <a class="w-[100%]" href="article.php?id=<?php echo $filter['article_id'] ?>">
                        <img class="h-[38vh] w-[100%]  rounded-t-lg" src="../assets/images/<?=$filter['article_image']?>"
                            alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <div class="h-[10vh]">
                        ...
                        <div class="flex items-center justify-between  h-[20%]">
                            ...
                            <div class="flex items-center gap-[5px]">
                                ...
                                <p class=" text-gray-600 text-[14px] ">
                                    <?php echo $filter["created_at"]; ?>
                                </p>
                            </div>
                            <form action="article_info.php" method="get">
                            <input type="hidden" name="id_article" value="<?=$filter['article_id']?>">
